        ...
        data.forEach(data => {
          ...
          const dataContent = data.content
            ? data.content
                ...
                .toLowerCase()
            : "";
          const blogConfigRoot = GLOBAL_CONFIG.root ? GLOBAL_CONFIG.root : "";
          const dataUrl = data.url.startsWith("http") ? data.url : data.url;
          let indexTitle = -1;
          let indexContent = -1;
          let firstOccur = -1;
            ...
            if (firstOccur >= 0) {
              ...
              if (dataTags.length) {
                ...
                for (let i = 0; i < dataTags.length; i++) {
                  ...
                  str +=
                    '<a class="tag-list" href="'+blogConfigRoot+'/tags/' +
                    element +
